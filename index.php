...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="/images/heart-beat-3517.png" alt=""/>
                        <h3>Welcome</h3>
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#reception" role="tab" aria-controls="reception" aria-selected="false">Reception</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" minlength="8" maxlength="9" name="nid" class="form-control" placeholder="Your National ID *" required/>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="tab-pane fade show" id="reception" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="User Name *" name="recusername" onkeydown="return alphaOnly(event);" required/>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="password" class="form-control" placeholder="Password *" name="recpassword" required/>
                                        </div>
                                        
                                        <input type="submit" class="btnRegister" name="recsub" value="Login"/>
                                    </div>
                                </div>
                            </form>
                            </div>

  ...
  if(isset($_POST['changepass']))
{
  if (isset($_SESSION['did'])){
      ...
      $pass = $_POST['password'];
      $query = "UPDATE doctb SET password = '$pass' WHERE d_id= '$did';";
...
.text-primary {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" method="post" action="search.php">
      <input class="form-control mr-sm-2" type="text" placeholder="Enter contact number or National ID" aria-label="Search" name="contact">
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Welcome &nbsp Dr.<?php echo $_SESSION['dname'] ?>  </h3>
    <div class="row">
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Password</h4>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select pid,ID,fname,lname,national_id,gender,email,contact,appdate,apptime,userStatus,doctorStatus from appointmenttb where doctor='$dname';";
                    $result = mysqli_query($con,$query);
                    while ($row = mysqli_fetch_array($result)){
                      ?>
                      <tr>
                      <td><?php echo $row['pid'];?></td>
                        <td><a href="patient-history.php?national_id=<?=$row['national_id']?>"><?php echo $row['national_id'];?></a></td>
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        <a href="prescribe.php?pid=<?php echo $row['pid']?>&ID=<?php echo $row['ID']?>&fname=<?php echo $row['fname']?>&lname=<?php echo $row['lname']?>&national_id=<?php echo $row['national_id']?>&appdate=<?php echo $row['appdate']?>&apptime=<?php echo $row['apptime']?>"
        ...
        <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select pid,fname,lname,ID,national_id,appdate,apptime,disease,allergy,prescription from prestb where doctor='$doctor';";

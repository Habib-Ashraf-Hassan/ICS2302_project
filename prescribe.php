...
if(isset($_GET['pid']) && isset($_GET['ID']) && ($_GET['appdate']) && isset($_GET['apptime']) && isset($_GET['fname']) && isset($_GET['lname']) && isset($_GET['national_id'])) {
$pid = $_GET['pid'];
  $ID = $_GET['ID'];
  $fname = $_GET['fname'];
  $lname = $_GET['lname'];
...
if(isset($_POST['prescribe']) && isset($_POST['pid']) && isset($_POST['ID']) && isset($_POST['appdate']) && isset($_POST['apptime']) && isset($_POST['lname']) && isset($_POST['fname']) && isset($_POST['national_id'])){
  ...
  $query=mysqli_query($con,"insert into prestb(doctor,pid,ID,national_id,fname,lname,appdate,apptime,disease,allergy,prescription) values ('$doctor','$pid','$ID','$national_id','$fname','$lname','$appdate','$apptime','$disease','$allergy','$prescription')");
    if($query)
    {
      // echo "<script>alert('Prescribed successfully!');</script>";
      $query=mysqli_query($con,"insert into pathist(patient_name,national_id,doctor_name,disease,allergy,prescription) values ('$full_name','$national_id','$doctor','$disease','$allergy','$prescription')");
      if($query)
      {
        echo "<script>alert('Prescribed successfully!');</script>";
      }
      else{
        echo "<script>alert('Unable to process your request into national health database Try again!');</script>";
      }

  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
               ...
               <div class="col-sm-4">
                ...
                <!-- <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                 ...
                 <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-comment fa-stack-1x fa-inverse"></i></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Feedbacks</h4>
                    
                      <p class="cl-effect-1">
                        <a href="#list-mes" onclick="clickDiv('#list-mes-list')">View feedbacks</a>
                        &nbsp|
      ...
      <div class="tab-pane fade" id="list-doc" role="tabpanel" aria-labelledby="list-home-list">
              ...
              <div class="col-md-8">
      <form class="form-group" action="doctor-search-recep.php" method="post">
        <div class="row">
    ...
    <div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
       ...
       <div class="col-md-8">
      <form class="form-group" action="patientsearch-recep.php" method="post">
        <div class="row">
      ...
      <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-pat-list">
         ...
         <div class="col-md-8">
      <form class="form-group" action="appt-search-recept.php" method="post">
        <div class="row">
                  ...
                  ?>
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                      echo "Cancelled by Doctor";
                        ...
                        ?></td>
                        <td><a href=""
                          class="btn btn-warning">Change Appointment status</a></td>
                      </tr>
                    <?php } ?>
                </tbody>
              </table>

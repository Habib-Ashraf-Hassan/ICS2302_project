...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
  	$query="insert into patreg(fname,lname,gender,email,contact,password,cpassword,national_id) values ('$fname','$lname','$gender','$email','$contact','$password','$cpassword', '$nid');";

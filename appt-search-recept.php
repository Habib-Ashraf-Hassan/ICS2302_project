...
if(isset($_POST['app_search_submit']))
{
	...
	$query = "select * from appointmenttb where contact= '$contact' or national_id='$contact';";
  ...
  <table class='table table-hover'>
    ...
    echo "</tbody></table><center><a href='reception-panel.php' class='btn btn-light'>Back to your Dashboard</a></div></center></div></div></div>";
  }
  }

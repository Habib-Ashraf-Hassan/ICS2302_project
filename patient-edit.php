...
if(isset($_POST['patedit'])){
        ...
        $query=mysqli_query($con,"UPDATE patreg
        SET fname = '$fname', lname = '$lname', email='$email', national_id='$national_id', contact='$contact',gender='$gender',password='$pass' WHERE pid = '$pid';");
          if($query)
          {
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;">ADMIN - Edit Patient </h3>
    <a href="admin-panel1.php"><button class="btn btn-success">Go back</button></a>
    <?php
        
    if(isset($_GET['fname']) && ($_GET['lname']) && isset($_GET['gender']) && isset($_GET['contact']) && isset($_GET['national_id']) && isset($_GET['email']) &&isset($_GET['pass'])
        &&isset($_GET['pid'])) {
        $lname = $_GET['lname'];
        $email = $_GET['email'];
        $fname = $_GET['fname'];
    ...
    ?>
    <form class="form-group" method="post" action="patient-edit.php">
          <div class="row">
                  <div class="col-md-4"><label>Patient First name:</label></div>
                  ...
                  <div class="col-md-4"><label>Patient last Name:</label></div>
                  <div class="col-md-8"><input type="text" class="form-control" name="lname" onkeydown="return alphaOnly(event);" value="<?=$lname?>" required></div><br><br>
                  ...
                  <div class="col-md-8"><input type="text" maxlength="11" minlength="10"  class="form-control" name="contact" value="<?=$contact?>" required></div><br><br>
          ...
          <input type="submit" name="patedit" value="Edit Patient" class="btn btn-primary" onclick="confirm('Do you wish to proceed?');">
        </form>
      </div>
      <?php }?>
